...
$result_per_page = 10;
 ...
 if(isset($_GET['del']))
                  {
                    $sql="DELETE FROM employee WHERE EmpID=".$_GET['del'];
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Employees</h1>
          	...
          	<div>
          	     <table class="table table-hover" id="tbl_Employee">
                      <tr>
                        <td>Employee ID</td>
                        <td>Firstname</td>
                        <td>Lastname</td>
                      ...
                      <?php
                          ...
                          $number_of_results = mysqli_num_rows($result);
                              ...
                              $number_n_pages = ceil($number_of_results / $result_per_page); //ceil is for round off                                
                              
                              //select the page and view the items
                              if(!isset($_GET['page']))
                              {$page=1;}                              
                              else
                                {$page = $_GET['page'];}
                              ...
                              while($row = mysqli_fetch_array($result))
                              {
                                ...
                                echo '<tr>'
                                    ...
                                    .'<td>'.$row['Lastname'].'</td>'
                                    .'<td>'
                                        .'<a href="Details.php?Empl='.$row['EmpID'].'" class="fas fa-eye" ></a>&nbsp;&nbsp;&nbsp;<a href="Employee.php?del='.$row['EmpID'].'" class="fas fa-trash-alt" ></a> &nbsp;&nbsp;&nbsp;<a href="UpdateEmployee.php?del='.$row['EmpID'].'" class="fas fa-pen-alt" ></a> '
                            ...
                            //create numbers for pagiantion selections
                              for($page = 1; $page <= $number_n_pages;$page++){
                                    echo '<a href="Employee.php?page='.$page.'" class="btn btn-secondary-sm">'.$page.'</a>';
